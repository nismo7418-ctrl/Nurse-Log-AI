...
1. ✅ **Dictée vocale réelle** - Utilisation de l'API OpenAI Whisper pour transcrire les fichiers audio
...
- ✅ 52 tests passants (1 skipped pour export PDF non installé)
